...
class AirlineSeating
  ...
  def initialize(*args)
    ...
    puts "The given 2D array  #{@input_seats} \n"
    puts "Total ticket required  #{@passengers_count} \n\n"
    if @message.nil?
  ...
  def validate_input(args)
    ...
    return "The second argument is invalid! Please enter the number of passengers." if args.flatten[1].empty?
    @passengers_count = args.flatten[1].to_i if !args.flatten[1].empty?
...
if seating.message.nil?
  ...
  puts"Seats allocated as follow"
